...
#or
#cd "C:\Users\elysia.kilayko\OneDrive\Documents\VS Code\Learning\Python\ZTM\pokedex"
...
#full input into the terminal window: python JPGtoPNGConverter_Attempt.py Pokedex New
